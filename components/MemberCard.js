  ...
  return (
    <div className="bg-white shadow-lg rounded-lg overflow-hidden transform transition duration-300 hover:scale-105 cursor-pointer">
      <div className="relative">
        {/* Responsive image height while maintaining aspect ratio */}
        <img src={member.image} alt={member.name} className="w-full object-cover"
             style={{ height: '250px', minHeight: '250px' }} />
        <a href={member.linkedin_url} target="_blank" rel="noopener noreferrer"
           className="absolute top-2 right-2 bg-blue-600 text-white p-2 rounded-full hover:bg-blue-700 transition duration-300">
          <FaLinkedin />
        </a>
      </div>
      <div className="p-4">
